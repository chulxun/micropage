...
module.exports = class WorksProxy {
  ...
  static publishWork(params) {
    const { work_id, publish_pages,publish_config } = params
    const updated_at = +Date.now()
    return Works.updateMany({ work_id: work_id }, { is_publish: true, publish_pages,publish_config, updated_at })
  }
}
